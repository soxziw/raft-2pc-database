...
class Client:
    ...
    def help(self):
        ...
        print('     - test_basic_intra_shard_success: Test basic intra-shard transaction success')
        print('     - test_basic_cross_shard_success: Test basic cross-shard transaction success')
        print('     - test_basic_cross_shard_failure: Test basic cross-shard transaction failure')
        print('     - test_concurrent_intra_shard_both_commit: Test concurrent intra-shard transactions both committing')
        print('     - test_concurrent_intra_shard_partial_failure: Test concurrent intra-shard with partial failure')
        print('     - test_concurrent_cross_shard_both_commit: Test concurrent cross-shard transactions both committing')
        print('     - test_concurrent_cross_shard_partial_failure: Test concurrent cross-shard with partial failure')
        print('     - test_crash_one_node_in_cluster: Test system behavior when one node crashes in a cluster')
        print('     - test_raft_failure_in_intra_shard: Test intra-shard transaction with Raft consensus failure')
        print('     - test_partition_leader_in_cluster: Test system behavior when cluster leader is partitioned')
        print('     - test_2pc_failure_due_to_cluster_partition: Test 2PC protocol with cluster partition')
